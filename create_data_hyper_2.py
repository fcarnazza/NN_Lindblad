...
if __name__ == '__main__':
    ...
    for k in range(len(cfg["system"]["potential"])):
        for j in range(len(cfg["system"]["beta"])):
            ...
            path = os.path.join(cfg["model_dir"], f"traj_fss_dyn_{beta}_{C_def}_2_spin.h5")
            path_eval_fin = os.path.join(cfg["model_dir"], f"traj_fss_final_{beta}_{C_def}_2_spin.h5")
